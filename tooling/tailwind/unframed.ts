...
export default {
  ...
  theme: {
    ...
    fontSize: {
        xs: [scaleFontSize("0.75"), { lineHeight: '1.3', letterSpacing: '0.05em', fontWeight: '500' }],
        sm: [scaleFontSize("0.875"), { lineHeight: '1.4', letterSpacing: '0.04em', fontWeight: '500' }],
        base: [scaleFontSize("1"), { lineHeight: '1.4', letterSpacing: '0.03em', fontWeight: '500' }],
        lg: [scaleFontSize("1.125"), { lineHeight: '1.3', letterSpacing: '0.025em', fontWeight: '500' }],
        xl: [scaleFontSize("1.25"), { lineHeight: '1.27', letterSpacing: '0.03em', fontWeight: '500' }],
